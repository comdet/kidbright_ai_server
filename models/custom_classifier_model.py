...
def create_classifier(cmds, labels):
    ...
    network = Classifier(model, input_size, labels, normalize)
...
class Classifier(object):
    ...
    def train(self,
        ...
        train_generator, validation_generator = create_datagen(img_folder, valid_img_folder, batch_size, self.input_size, project_folder, augumentation, self.norm)
